...
export const FALLBACK_EVENTS: RoboxenceEvent[] = [
  {
    ...
    format: "Team or Individual",
    entryFee: "₹160/- per Team or Individual",
    price: 3000,
  ...
  },
  {
    ...
    format: "Solo or With Friend",
    entryFee: "Solo: ₹50/- | With Friend: ₹80/-",
    price: 2000,
    ...
    iconName: "Binary",
    keyRules: [
      "Registration Options: Solo — ₹50/- | With Friend — ₹80/-.",
